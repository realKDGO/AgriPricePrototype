...
].map(([id, name, location, distanceKm, transport]) => ({ id, name, location, distanceKm, transport, status: "Active" }));
export const prices = crops.flatMap((c, i) =>
  markets.map((m, j) => ({
    ...
    previous: c.base + [0, 2, -2, 3, -1, 1, 4][j] - [2, -3, 1, 0, 4, -1, 2, 3][i],
    date: SNAPSHOT,
    status: "Verified",
    source: "MAO record",
  })),
...
export const forecasts = crops.flatMap((c) =>
  Array.from({ length: 6 }, (_, i) => ({
    id: `forecast-${c.id}-${i}`,
    cropId: c.id,
    date: `${i < 3 ? 2026 : 2027}-${String(((i + 9) % 12) + 1).padStart(2, "0")}-01`,
    price: Math.round(c.base * (1 + (i + 1) * 0.018) * 100) / 100,
    status: "Available",
  })),
);
export const users = [
  ...
  },
  {
    ...
    email: "admin@agriprice.local",
    role: "ADMIN",
    status: "Active",
    municipality: "Jala-Jala",
    lastLogin: "2026-09-05 07:45",
    password: "AgriPrice2026",
  },
];
export const audit = [
  {
    id: "audit-1",
    date: "2026-09-05 08:20",
    actor: "Juan dela Cruz",
    action: "Signed in to farmer Account",
    type: "Session",
    status: "Success",
  },
  {
    ...
    actor: "Elena Reyes",
    action: "Reviewed price submissions",
  ...
  },
  {
    ...
    action: "Reviewed account access",
    type: "Administration",
    status: "Success",
  },
];
export const reports = [
  {
    id: "prices",
    name: "Crop Price Report",
    description: "Verified prices by crop and market.",
  },
  {
    id: "markets",
    name: "Market Comparison",
    description: "Compare available market quotations.",
  },
  {
    id: "history",
    name: "Historical Trends",
    description: "Recorded crop prices over time.",
  },
  {
    id: "forecasts",
    name: "Forecast Summary",
    description: "Expected crop price movement for the next six months.",
  },
];
export const technicalReports = [
  { id: "accounts", name: "Account Summary" },
  { id: "activity", name: "System Activity Report" },
];
export const initialData = {
  ...
  reports,
  technicalReports,
  settings: { textSize: "standard", defaultCrop: "rice", sessionTimeout: 30 },
  backups: [],
};
